...
"Imported {count} of {total} contacts" => "Importés {count} sur {total} contacts",
...
"Attempt to upload blacklisted file:" => "Tentative de télécharger un fichier sur liste noire:",
"File name missing from request." => "Nom de fichier manquant dans la recherche.",
"Progress key missing from request." => "Clé de progression manquante dans la requête.",
"Attempt to access blacklisted file:" => "Tentative d'accès à un fichier sur liste noire:",
