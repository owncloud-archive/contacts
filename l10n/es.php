...
"Save" => "Guardar",
"Uploading..." => "Subiendo...",
"Imported {count} of {total} contacts" => "Importados {count} de un total de {total}",
"Imported {imported} contacts. {failed} failed." => "Importados {imported} contacots. Ha fallado {failed}.",
"An address book called {name} already exists" => "Ya existe una libreta de direcciones llamada {name}",
