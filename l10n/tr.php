...
"Close" => "Kapat",
"Failed loading photo: {error}" => "Fotoğraf yüklemesi başarısız: {error}",
...
"The backend for this contact does not support updating it" => "Bu kişi için arka uç güncellemeyi desteklemiyor.",
"This backend not support adding contacts" => "Bu arka uç kişi eklemeyi desteklemiyor.",
