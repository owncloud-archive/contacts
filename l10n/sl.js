OC.L10N.register(
    ...
    {
    "Contacts" : "Stiki",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "Ali ste prepričani, da želite pobrisati imenik {addressbook}?",
    ...
    "Please specify a valid Federated Cloud ID." : "Prosim vpiši veljavno oznako Povezanega Oblaka (Federated Cloud ID)",
    "username@example.com/owncloud" : "uporabnik@domena.si/owncloud",
    "Delete Federated Cloud ID" : "Pobriši oznako Povezanega Oblaka (Federated Cloud ID)",
