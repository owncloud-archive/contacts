OC.L10N.register(
    ...
    {
    "Contacts" : "Stiki",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "Ali ste prepričani, da želite izbrisati imenik {addressbook}?",
    "Remove addressbook" : "Odstrani imenik",
    ...
    "Federated Cloud ID" : "Oznaka Povezanega Oblaka (Federated Cloud ID)",
    ...
    "Please specify a valid Federated Cloud ID." : "Vpisati je treba veljavno oznako Povezanega Oblaka (Federated Cloud ID)",
    "username@example.com/owncloud" : "uporabnik@domena.si/owncloud",
    "Delete Federated Cloud ID" : "Izbriši oznako Povezanega Oblaka (Federated Cloud ID)",
