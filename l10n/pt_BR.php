...
"The backend for this address book does not support adding contacts" => "O backend para este catálogo de endereços não suporta a adição de contatos",
"You do not have permissions to delete this contact" => "Você não tem permissão para excluir esse contato",
"The backend for this address book does not support deleting contacts" => "O backend para este catálogo de endereços não suporta a exclusão de contatos",
"The backend for this address book does not support updating" => "O backend para este catálogo de endereços não suporta a atualização",
...
"The backend for this contact does not support updating it" => "O backend para este contato não suporta atualizá-lo",
"This backend not support adding contacts" => "Este backend não suporta adicionar contatos",
