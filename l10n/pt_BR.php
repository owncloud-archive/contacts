...
"Imported {imported} contacts. {failed} failed." => "Importado {imported} contatos. {failed} falharam.",
"An address book called {name} already exists" => "Um livro de endereços chamado {name} já existe",
"Failed adding address book: {error}" => "Falha na adição do livro de endereços: {error}",
"Failed loading address books: {error}" => "Falha ao ler o livro de endereços: {error}",
"Indexing contacts" => "Indexando contatos",
"Unrecoverable error loading address books: {msg}" => "Erro irrecuperável carregando livros de endereços: {msg}",
"Error." => "Erro.",
"Add to..." => "Adicionar a...",
"Remove from..." => "Remover de...",
"Add group..." => "Adicionar grupo...",
"Invalid URL: \"{url}\"" => "URL inválida:\"{url}\"",
"There was an error opening a mail composer." => "Houve um erro ao abrir um editor de e-mail.",
"Invalid email: \"{url}\"" => "E-mail inválido: \"{url}\"",
...
"Merge failed. Error saving contact." => "A mesclagem falhou. Erro ao salvar contato.",
...
"Error setting {name} as favorite." => "Erro adicionando {name} como favorito.",
...
"Failed renaming group: {error}" => "Falha ao renomear grupo:{error}",
...
"Failed adding group: {error}" => "Falha ao adicionar grupo: {error}",
"All" => "Todos",
"Favorites" => "Favoritos",
"Shared by {owner}" => "Compartilhado por {owner}",
"Not grouped" => "Não agrupado",
"Failed loading groups: {error}" => "Falha ao carregar grupos:{error}",
"Result: " => "Resultado:",
" imported, " => "importado,",
" failed." => "falhou.",
"Error" => "Erro",
...
"More..." => "Mais...",
"Less..." => "Menos...",
"Failed loading photo: {error}" => "Falha ao carregar foto: {error}",
"You do not have permissions to see this contacts" => "Você não tem permissão para ver este contato",
"You do not have permissions to see these contacts" => "Você não tem permissão para ver estes contatos",
"You do not have permissions add contacts to the address book" => "Você não tem permissão para adicionar contatos ao catálogo de endereços",
"The backend for this address book does not support adding contacts" => "O back-end deste catálogo de endereços não admite a adição de contatos",
"You do not have permissions to delete this contact" => "Você não tem permissão para excluir esse contato",
"The backend for this address book does not support deleting contacts" => "O back-end deste catálogo de endereços não admite a exclusão de contatos",
"The backend for this address book does not support updating" => "O back-end deste catálogo de endereços não admite a atualização",
...
"Address book not found" => "Livro de endereços não encontrado",
...
"The backend for this contact does not support updating it" => "O back-end deste contato não admite sua atualização",
"This backend not support adding contacts" => "Este back-end não admite adicição de contatos",
"Property not found" => "Propriedade não encontrada",
" Missing IM parameter for: " => "Falta parâmetro de IM para:",
"Unknown IM: " => "IM desconhecido:",
"Error creating address book" => "Erro ao criar livro de endereço",
"Error updating address book" => "Erro ao atualizar o livro de endereço",
"Error deleting address book" => "Erro ao excluir livro de endereço",
"Error creating contact." => "Erro ao criar contato.",
"Error deleting contact." => "Erro ao excluir conato.",
"Error retrieving contact." => "Erro ao recuperar contato.",
"Error removing contact from other address book." => "Erro ao remover contato de outro livro de endereços.",
"Couldn't find contact." => "Não foi possível encontrar o contato.",
"Error merging into contact." => "Erro mesclando ao contato.",
"Error saving contact to backend." => "Erro ao salvar contato no back-end.",
"Property name is not set." => "Nome da propriedade não está definida.",
"Property checksum is not set." => "A soma de verificação da propriedade não está definida.",
...
"Error saving property to backend" => "Erro ao salvar propriedade no back-end",
...
"No group name to rename to given." => "O novo nome do grupo a ser renomeado não foi fornecido",
"Error renaming group." => "Erro ao renomear grupo.",
"Group ID missing from request." => "O ID do grupo requisitado não foi encontrado.",
"Group name missing from request." => "A requisição não contém o nome do grupo",
...
"Attempt to access blacklisted file:" => "Tente acessar o arquivo de lista negra:",
...
"Address books" => "Agendas de contatos",
...
"Groups" => "Grupos",
"Favorite" => "Favorito",
"Merge selected" => "Mesclar os selecionados",
"Close" => "Fechar",
...
"Which contact should the data be merged into?" => "Para qual contato devem os dados ser incorporados?",
