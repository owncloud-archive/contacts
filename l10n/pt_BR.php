...
"No contact info was submitted." => "Nenhuma informação de contato foi enviado.",
...
"Upload of blacklisted file:" => "Enviar arquivo lista negra:",
...
"Failed adding address book: {error}" => "Falha adicionando livro de endereços: {error}",
"Failed loading address books: {error}" => "Falha carregando livro de endereços: {error}",
...
"There was an error opening a mail composer." => "Houve um erro ao abrir um editortor de e-mail.",
...
"Network or server error. Please inform administrator." => "Erro de rede ou servidor. Por favor, informe ao administrador.",
"Error adding to group." => "Erro adicionando para o grupo.",
"Error removing from group." => "Erro movendo para o grupo.",
"Error setting {name} as favorite." => "Erro configurando {nome} como favorito.",
"Merge contacts" => "Mesclar contatos",
"Cancel" => "Cancelar",
"Add group" => "Adicionar grupo",
"OK" => "OK",
"Could not find contact: {id}" => "Não foi possível encontrar contato: {id}",
...
"Is this correct?" => "Isso esta correto?",
"# groups" => "# grupos",
...
"Cancelled deletion of {num}" => "Cancelado exclusão de {num}",
"Add" => "Adicionar",
...
"More..." => "Mais...",
"Less..." => "Menos...",
"Failed loading photo: {error}" => "Falha ao carregando foto: {error}",
"You do not have permissions to see this contacts" => "Você não tem permissão para ver esses contatos",
"You do not have permissions to see these contacts" => "Você não tem permissão para ver esses contatos",
"You do not have permissions add contacts to the address book" => "Você não tem permissões para adicionar contatos a o livro de endereços.",
...
"Group name missing from request." => "O nome do grupo ausente do pedido.",
"Contact ID missing from request." => "O ID do contato requisitado não foi encontrado.",
"Attempt to upload blacklisted file:" => "Tentando enviar o arquivo de lista negra:",
...
"Sort order" => "Ordenar",
"First- Lastname" => "Primeiro Nome",
"Last-, Firstname" => "Sobrenome",
"Groups" => "Grupos",
"Favorite" => "Favorito",
...
"Which contact should the data be merged into?" => "Que dados de contato devem ser incorporados?",
