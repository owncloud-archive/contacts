...
"No contact info was submitted." => "연락처 정보가 제출되지 않았습니다.",
...
"Save" => "저장",
"Uploading..." => "업로드 중...",
"Imported {count} of {total} contacts" => "연락처 {total}명 중 {count}명 가져옴",
"Imported {imported} contacts. {failed} failed." => "연락처 {imported}명을 가져왔고, {failed}명은 실패하였습니다.",
"An address book called {name} already exists" => "주소록 {name}이(가) 이미 존재함",
"Failed adding address book: {error}" => "주소록 추가 오류: {error}",
"Failed loading address books: {error}" => "주소록 불러오기 오류: {error}",
"Indexing contacts" => "연락처 인덱스 작성 중",
"Add to..." => "다음에 추가...",
"Remove from..." => "다음에서 삭제...",
"Add group..." => "그룹 추가...",
"Merge failed. Cannot find contact: {id}" => "합칠 수 없습니다. 연락처를 찾을 수 없음: {id}",
"Merge failed." => "합칠 수 없습니다.",
"Merge failed. Error saving contact." => "합칠 수 없습니다. 연락처를 저장할 수 없습니다.",
"Select photo" => "사진 선택",
"Network or server error. Please inform administrator." => "네트워크 및 서버 오류입니다. 관리자에게 알려 주십시오.",
"Failed saving sort order: {error}" => "정렬 순서 저장 오류: {error}",
"Failed saving last group: {error}" => "마지막 그룹 저장 오류: {error}",
...
"Error setting {name} as favorite." => "{name}을(를) 즐겨찾는 연락처로 설정하는 중 오류가 발생하였습니다.",
...
"Failed deleting property: {error}" => "속성 삭제 오류: {error}",
...
"Failed deleting group: {error}" => "그룹 삭제 오류: {error}",
...
"Error deleting contact." => "연락처를 삭제하는 중 오류가 발생하였습니다.",
"Couldn't find contact." => "연락처를 찾을 수 없습니다.",
"Error merging into contact." => "연락처에 합치는 중 오류가 발생하였습니다.",
...
"Error setting property" => "속성 설정 오류",
"Error saving property to backend" => "백엔드에 속성 저장 오류",
"No group name given." => "그룹 이름이 주어지지 않았습니다.",
...
"Attempt to upload blacklisted file:" => "블랙리스트된 파일 업로드 시도함:",
"File name missing from request." => "요청에 파일 이름이 없습니다.",
"Progress key missing from request." => "요청에 진행 키가 없습니다.",
"Attempt to access blacklisted file:" => "블랙리스트된 파일에 접근 시도함:",
