...
"Save" => "Uložit",
"Uploading..." => "Odesílám...",
"Imported {count} of {total} contacts" => "Importováno {count} z {total} kontaktů",
"Imported {imported} contacts. {failed} failed." => "Importováno {imported} kontaktů. {failed} selhalo.",
"An address book called {name} already exists" => "Kniha adres s názvem {name} již existuje",
...
"File name missing from request." => "V požadavku schází název souboru.",
"No contacts found in: " => "Nenalezeny žádné kontakty v:",
