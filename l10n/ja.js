OC.L10N.register(
    ...
    "Add a new contact or import existing contacts from a file (VCF, CSV or LDIF)." : "新しい連絡先を追加、もしくは既存の連絡先をファイル（VCF, CSV, LDIF）からインポートしてください。",
    ...
    "Please specify a valid Federated Cloud ID." : "有効な統合されたクラウドIDを指定してください",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "統合されたクラウドIDを削除",
