OC.L10N.register(
    ...
    "Please specify a valid Federated Cloud ID." : "Будь ласка, вкажіть дійсний Об'єднаний Хмарний Ідентіфікатор.",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "Видалити Об'єднаний Хмарний Ідентіфікатор ",
