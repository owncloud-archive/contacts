...
"LDAP Directories for Contacts" => "Carpetes LDAP dels contactes",
"Server configuration" => "Configuració del servidor",
"Add LDAP addressbook" => "Afegeix llibreta d'adreces LDAP",
"Delete Addressbook" => "Elimina llibreta d'adreces",
"Addressbook name" => "Nom de la llibreta d'adreces",
"Name of the addressbook" => "Nom de la llibreta d'adreces",
"Addressbook description" => "Descripció de la llibreta d'adreces",
"Addressbook uri" => "URI de la llibreta d'adreces",
"Must be unique" => "Ha de ser única",
...
"Search is recursive" => "La cerca és recursiva",
"Read only" => "Només de lectura",
"Base DN for modification" => "DN Base per modificació",
"All new contacts will be saved in this directory" => "Tots els contactes nous es desaran en aquesta carpeta",
"Anonymous" => "Anònim",
"User" => "Usuari",
"Password" => "Contrasenya",
"LDAP to VCard connector XML" => "Connector XML de LDAP a VCard",
"Test connection" => "Comprova la connexió",
"Help" => "Ajuda",
