...
"Error loading image." => "Errore di caricamento dell'immagine.",
...
"Error uploading contacts to storage." => "Errore durante il caricamento dei contatti nell'archivio.",
...
"No files selected for upload." => "Nessun file selezionato per il caricamento",
"The file you are trying to upload exceed the maximum size for file uploads on this server." => "I file che stai provando a caricare superano la dimensione massima consentita su questo server.",
...
"Property name is not set." => "La proprietà Nome non è impostata.",
"Property checksum is not set." => "La proprietà Codice di controllo non è impostata.",
...
"No group name to rename from given." => "Nessun nome gruppo di origine fornito.",
