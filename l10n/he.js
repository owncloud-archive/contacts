OC.L10N.register(
    ...
    {
    "Contacts" : "אנשי קשר",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "האם באמת למחוק את פנקס הכתובות {addressbook} ?",
    "Remove addressbook" : "הסרת פנקס כתובות",
    ...
    "Automatic format detection" : "גילוי פורמט אוטומטי",
    "Import into..." : "מידע יבוא...",
    "Processing {count}/{total} cards" : "מעבד {count}/{total} רשומות",
    "Total: {total}, Success: {imported}, Errors: {failed}" : "סך הכול: {total}, יובאו בהצלחה: {imported}, שגיאות: {failed}",
    ...
    "Please create an addressbook first" : "יש ליצור קודם פנקס כתובות",
    ...
    "No contact data in request." : "אין מידע איש קשר בבקשה.",
    "Error merging into contact." : "שגיאה בזמן מיזוג לתוך איש קשר.",
    "Error saving contact to backend." : "שגיאה בזמן שמירה למסד הנתונים.",
    "Property name is not set." : "שם תכונה לא נקבע.",
    "Property checksum is not set." : "בדיקת תכונה לא נקבעה.",
    ...
    "No group ID given." : "לא הוזן מספר זיהוי קבוצה.",
    "No group name to rename from given." : "לא הוזן שם קבוצה לצורך שינוי השם",
    "No group name to rename to given." : "לא הוזן שם קבוצה לצורך שינוי השם",
    "Error renaming group." : "שגיאה בזמן שינוי שם קבוצה.",
    "Group ID missing from request." : "חסר מספר זיהוי קבוצה בבקשה",
    "Group name missing from request." : "חסר שם קבוצה בבקשה",
    "Contact ID missing from request." : "חסר מספר זיהוי איש קשר בבקשה",
    ...
    "Error moving file to imports folder." : "שגיאה בהעברת קובץ לתיקיית יבוא",
    "You do not have permissions to import into this address book." : "אין ברשותך ההרשאות המתאימות ליבוא אל תוך פנקס הכתובות הזה.",
    "File name missing from request." : "חסר שם קובץ בבקשה",
    "Progress key missing from request." : "חסר מפתח התקדמות בבקשה",
    "Attempt to access blacklisted file:" : "ניסיון לכניסה לקובץ רשימה שחורה:",
    "Other" : "אחר",
    "HomePage" : "דף בית",
    "Jabber" : "Jabber",
    ...
    "Friends" : "חברים",
    "Family" : "משפחה",
    "Enable LDAP Backend" : "אפשר צד אחורי LDAP",
    "Enable LDAP backend for the contacts application" : "אפשר צד אחורי LDAP ליישום אנשי הקשר",
    "Warning: LDAP Backend is in beta mode, use with precautions" : "אזהרה: צד אחורי LDAP הנו ניסיוני, יש להשתמש בזהירות ",
    ...
    "Add LDAP Address Book" : "הוספת פנקס כתובות LDAP",
    ...
    "Please specify a valid Federated Cloud ID." : "יש לספק מספר זיהוי ענן מאוגד חוקי",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "מחיקת מספר זיהוי ענן מאוגד",
    ...
    "Edit" : "עריכה",
    "Format" : "עיצוב",
    "Automatic format" : "פורמט אוטומטי",
    ...
    "User" : "שתמש",
    "Page size" : "גודל עמוד",
    "Base DN for search" : "DN בסיסי לחיפוש",
    "Base DN" : "DN בסיסי",
    "Search filter" : "חיפוש על בסיס סינון",
    "Filter" : "סינון",
    "Base DN for modification" : "DN בסיסי לשינוי",
    "Base DN modification" : "מוד DN בסיסי",
    "Connector" : "מחבר",
    "Connector value (Better use external editor and copy/paste)" : "ערך מחבר (עדיף להשתמש בעורך חיצוני והעתק/הדבק)",
    "Copy from (Warning, replaces current custom value)" : "העתקה מ- (הזהרה, מחליף ערך מותאם אישית נוכחי)"
},
