OC.L10N.register(
    ...
    {
    "Contacts" : "Kontak",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "Apakah Anda yakin ingin menghapus buku alamat {addressbook} ?",
    "Remove addressbook" : "Hapus buku alamat",
    ...
    "Server error! Please inform system administator" : "Kesalahan server! Silakan menginformasikan administrator sistem.",
    "Indexing contacts" : "Mengindeks kontak",
    "Unrecoverable error loading address books: {msg}" : "Kesalahan yang tidak diketahui ketika memuat buku alamat: {msg}",
    "Error." : "Kesalahan.",
    "Add to..." : "Tambah ke...",
    ...
    "Merge failed. Error saving contact." : "Gagal gabung. Kesalahan menyimpan kontak.",
    "Select photo" : "Pilih foto",
    "Network or server error. Please inform administrator." : "Kesalahan jaringan atau server. Silahkan menginformasikan administrator.",
    ...
    "Error adding to group." : "Terjadi kesalahan saat menambahkan ke grup.",
    "Error removing from group." : "Terjadi kesalahan saat menghapus dari grup.",
    ...
    "Error setting {name} as favorite." : "Terjadi kesalahan saat mengatur {name} sebagai favorit",
    ...
    "Error loading import template" : "Terjadi kesalahan saat memuat templat impor",
    "Import" : "Impor",
    "Importing..." : "Mengimpor...",
    ...
    "Error creating address book" : "Terjadi kesalahan saat membuat buku alamat",
    ...
    "Error deleting address book" : "Terjadi kesalahan saat menghapus buku alamat",
    "Error creating contact." : "Terjadi kesalahan saat membuat kontak",
    "Error creating contact" : "Terjadi kesalahan saat membuat kontak",
    "Error deleting contact" : "Terjadi kesalahan saat menghapus kontak",
    "Error retrieving contact" : "Terjadi kesalahan saat menerima kontak",
    "Error saving contact" : "Terjadi kesalahan saat menyimpan kontak",
    "Error removing contact from other address book." : "Terjadi kesalahan saat menghapus kontak dari buku alamat lainnya.",
    "Error getting moved contact" : "Terjadi kesalahan saat memindahkan kontak",
    "Couldn't find contact." : "Tidak menemukan kontak.",
    "No contact data in request." : "Tidak ada data kontak yang diminta.",
    "Error merging into contact." : "Terjadi kesalahan saat menggabungkan kedalam kontak.",
    ...
    "Error updating contact" : "Terjadi kesalahan saat memperbarui kontak",
    "Error saving contact to backend" : "Terjadi kesalahan saat menyimpan kontak ke backend",
    "No photo path was submitted." : "Tidak ada foto yang ditambahkan.",
    "Error loading image from cache" : "Terjadi kesalahan saat memuat gambar dari cache",
    "Error getting PHOTO property." : "Terjadi kesalahan saat mengambil properti FOTO.",
    "Error saving contact." : "Terjadi kesalahan saat menyimpan kontak.",
    "No group name given." : "Tidak ada nama grup yang diberikan.",
    "Error adding group." : "Terjadi kesalahan saat menambahkan grup.",
    ...
    "Error renaming group." : "Terjadi kesalahan saat mengubah nama grup",
    ...
    "Error uploading contacts to storage." : "Terjadi kesalahan saat mengunggah kontak ke penyimpanan",
    "Error moving file to imports folder." : "Terjadi kesalahan saat memindahkan berkas ke folder impor.",
    ...
    "Please specify a valid Federated Cloud ID." : "Silakan tetapkan Federated Cloud ID yang benar.",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "Hapus Federated Cloud ID",
