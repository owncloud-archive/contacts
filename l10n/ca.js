OC.L10N.register(
    ...
    {
    "Contacts" : "Contactes",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "Segur que voleu eliminar la llibreta d'adreces {addressbook}?",
    "Remove addressbook" : "Esborra la llibreta d'adreces",
    ...
    "Please specify a valid Federated Cloud ID." : "Especifiqueu una ID de núvol federat vàlida",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "Esborra la ID de núvol federat",
