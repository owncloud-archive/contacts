OC.L10N.register(
    ...
    {
    "Contacts" : "Contacts",
    "Are you sure you want to delete the addressbook {addressbook} ?" : "Are you sure you want to delete the addressbook {addressbook} ?",
    "Remove addressbook" : "Remove addressbook",
    ...
    "Please specify a valid Federated Cloud ID." : "Please specify a valid Federated Cloud ID.",
    "username@example.com/owncloud" : "username@example.com/owncloud",
    "Delete Federated Cloud ID" : "Delete Federated Cloud ID",
