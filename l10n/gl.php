...
"Imported {imported} contacts. {failed} failed." => "Importados {imported} contactos. {failed} fallado(s).",
"An address book called {name} already exists" => "Xa existe un caderno de enderezos chamado {name}",
"Failed adding address book: {error}" => "Non foi posíbel engadir os cadernos de enderezos: {error}",
...
"Group name missing from request." => "Falta o nome do grupo desde a petición.",
"Contact ID missing from request." => "Falta o ID do contacto desde a solicitude.",
"Attempt to upload blacklisted file:" => "Tentar enviar o ficheiro da lista negra:",
...
"File name missing from request." => "Falta o nome do ficheiro desde a solicitude.",
"Progress key missing from request." => "Falta a chave de progreso desde solicitude.",
"Attempt to access blacklisted file:" => "Tentar acceder ao ficheiro da lista negra:",
...
"someone@example.com" => "calquera@dominio.gal",
...
"Share" => "Compartir",
"Export" => "Exportar",
"CardDAV link" => "Ligazón á CardDAV",
