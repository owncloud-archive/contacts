...
"Failed adding address book: {error}" => "Fehler beim Hinzufügen des Adressbuches: {error}",
...
"Failed deleting property: {error}" => "Fehler beim Löschen einer Eigenschaft: {error}",
...
"Property name is not set." => "Eigenschaftsname ist nicht angegeben.",
"Property checksum is not set." => "Eigenschaftsprüfsumme ist nicht angegeben.",
"Information about vCard is incorrect. Please reload the page." => "Die Information der vCard ist fehlerhaft. Bitte aktualisiere die Seite.",
"Error setting property" => "Fehler beim Setzen einer Eigenschaft",
"Error saving property to backend" => "Fehler beim Speichern einer Eigenschaft ins Backend",
